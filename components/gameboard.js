...
export default function Gameboard() {
    ...
    // number of throwsleft, status and points away from bonus
   ...
   //selecting points to number and create array filled with false
    ...
    // selecting dices and points and create array filled with flase
    ...
    function selectDice(i) {
     ...
     // function to set color to black when dice is selected
